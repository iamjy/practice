...
static void w_fun1(struct work_struct *w_arg)
{
	struct my_dat *data = container_of(w_arg, struct my_dat, work1);
	pr_info("I am in w_fun1, jiffies = %ld\n", jiffies);
