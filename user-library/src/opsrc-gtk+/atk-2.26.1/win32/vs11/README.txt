...
-g-ir-scanner needs to be found at <root>\vs11\<PlatformName>\bin, and the
 other Python items needs to be under <root>\vs11\<PlatformName>\lib\gobject-introspection.
