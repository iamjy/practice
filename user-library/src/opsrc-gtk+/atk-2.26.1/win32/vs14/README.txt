...
-g-ir-scanner needs to be found at <root>\vs14\<PlatformName>\bin, and the
 other Python items needs to be under <root>\vs14\<PlatformName>\lib\gobject-introspection.
