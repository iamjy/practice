...
-g-ir-scanner needs to be found at <root>\vs15\<PlatformName>\bin, and the
 other Python items needs to be under <root>\vs15\<PlatformName>\lib\gobject-introspection.
