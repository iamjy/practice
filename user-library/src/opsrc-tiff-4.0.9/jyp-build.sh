...
CMK_TOOLCHAIN_FILE="./cmake-rule/toolchain.arm.cmake"
...
: <<'END'
cmake -DCMAKE_INSTALL_PREFIX=${TARGET_PATH} -DCMAKE_TOOLCHAIN_FILE=${CMK_TOOLCHAIN_FILE}
[ $? = 0 ] && ./configure --prefix=${TARGET_PATH}  && make && make install
END
